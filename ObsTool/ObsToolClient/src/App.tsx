...
import { faHome, faPlus, faSearch, faTable, faBinoculars, faEyeSlash, faMapMarked, faThumbsUp, faThumbsDown, faStar, faStarHalfAlt, faUndoAlt, faTimes, faExclamationTriangle } from "@fortawesome/free-solid-svg-icons";
...
class App extends React.Component<{}, {}> {
  constructor(props: any) {
    ...
    library.add(
      ...
      faStarHalfAlt, faUndoAlt, faTimes, faExclamationTriangle);
  }
